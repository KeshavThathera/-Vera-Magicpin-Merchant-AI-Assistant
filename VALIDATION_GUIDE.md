...
**Endpoint**: Hosted bot (https://vera-magicpin-merchant-ai-assistant.onrender.com)  
**Time**: ~30 sec  
...
```bash
# Hosted bot
python validate_case_studies.py --bot-url https://vera-magicpin-merchant-ai-assistant.onrender.com
...
🔍 Vera Case Studies Validator
   Bot URL: https://vera-magicpin-merchant-ai-assistant.onrender.com
   Case Studies: 10
================================================================================
...
export BOT_URL=https://vera-magicpin-merchant-ai-assistant.onrender.com
